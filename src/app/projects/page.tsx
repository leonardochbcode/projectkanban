...
function ProjectsListTab() {
  const { projects, currentUser, getRole, duplicateProject, clients } = useStore();
  ...
  }, [projects, currentUser, canViewAllProjects, nameFilter, statusFilter, clientFilter]);
    ...
    <Card>
      ...
      <CardContent>
        ...
        <ManageProjectDialog project={editingProject} open={isDialogOpen} onOpenChange={handleDialogClose}>
          {/* O diálogo é acionado programaticamente */}
        </ManageProjectDialog>
        <Table>
          <TableHeader>
            <TableRow>
  ...
  return (
    <div className="flex-1 space-y-4 p-4 sm:p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h1 className="text-3xl font-bold tracking-tight font-headline">Projetos e Templates</h1>
